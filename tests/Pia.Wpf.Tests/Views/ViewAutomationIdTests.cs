...
public class ViewAutomationIdTests
{
    ...
    [InlineData(typeof(Pia.Views.AssistantView), 25, 6,
    ...
    [InlineData(typeof(Pia.Views.RoutinesView), 18, 1, "PiaEmptyState,PiaHelpHint,PiaRoutinesSearchBar")]
    ...
    [InlineData(typeof(Pia.Controls.Vault.PiaVaultOverview), 8, 0, "")]
    ...
    [InlineData(typeof(Pia.Controls.AssistantHistory.PiaAssistantChatRowContent), 2, 2, "PiaChatStateBadge")]
