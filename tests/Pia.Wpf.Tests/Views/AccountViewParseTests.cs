...
public class AccountViewParseTests
{
    ...
    {
        // The root DataContext is CHECKED, not assumed: SettingsView.xaml:136 hosts this view with
        // DataContext="{Binding AccountVm}", so the walk below is only sound while that property still has
        // this type.
