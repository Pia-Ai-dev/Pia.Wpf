    ...
    public IList<AITool> GetTools()
    {
        ...
        [
            ...
            AIFunctionFactory.Create(ReadFileSchema, "read_file",
                "Read the contents of a text file inside the assistant files folder. Use this before summarizing or updating a file. Locate the file with find_files first if you do not already know its path."),
