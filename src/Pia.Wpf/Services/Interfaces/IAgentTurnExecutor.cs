...
public sealed record RunProfile(int MaxSteps, int MaxReplans, TimeSpan WallClock)
{
    ...
    public const int MinSteps = 1, MaxStepsCap = 48, MinReplans = 0, MaxReplansCap = 5, MinWallClockMinutes = 1, MaxWallClockMinutes = 120, MinToolRounds = 1, MaxToolRoundsCap = 48;
