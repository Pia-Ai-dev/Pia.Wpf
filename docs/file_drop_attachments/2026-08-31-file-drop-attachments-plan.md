...
5. **Does the Outlook drag have to work before this ships?** Gate G0. The answer changes the shape of the whole feature, not just a step, so it is asked before A1 rather than deferred to round 3.
