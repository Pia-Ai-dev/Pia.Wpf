...
| Settings → Optimize | `Settings_Optimize_GoToProvidersTab`, `_OutputAction`, `_AutoTypeDelayMs`; the template master-detail pane below them uses the `Templates_*` / `TemplateEdit_*` ids above |
