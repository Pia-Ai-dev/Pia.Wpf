...
| **M1** Anwendung | Fenstertitel `Pia AI Assistant (v…)`. Neue Einstellungsseite **Info/About** (`Views/SettingsViews/AboutView.xaml`): Version, Herausgeber, KI-Hinweis, Links auf Impressum, Datenschutzerklärung, Dokumentation, Website (`Models/PiaLinks.cs`). |
